...
```{r}
#| label: tbl-mean-var
#| tbl-cap: Comparison of Mean and Variance of Total Death in from 2001 to 2022
#| echo: false
#| warning: false
...
# Create a table
kable(summary_stats, caption = "Comparison of Mean and Variance of Total Deaths")
